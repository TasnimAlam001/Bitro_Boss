import { FaBook, FaCalendarAlt, FaHome, FaListUl, FaShoppingBag, FaShoppingCart, FaUsers, FaUtensils, FaWallet } from "react-icons/fa";
        ...
        <div className="drawer drawer-mobile">
            ...
            <div className="drawer-side bg-[#D1A054]">
                ...
                <ul className="menu p-4 w-80 h-full text-base-content">
                    ...
                    <li><NavLink to="/menu">Contact</NavLink></li>
